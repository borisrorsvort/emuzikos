if Rails.env.production?
  IntercomRails.config do |config|
    # == Intercom app_id
    #
    config.app_id = ENV["INTERCOM_APP_ID"] || "cd5d5f413967c17c9179b07bd853f7846b65b70b"

    # == Intercom secret key
    # This is required to enable secure mode, you can find it on your Intercom
    # "security" configuration page.
    #
    config.api_secret = "whychooosesomestupidsecretnumber"
    # == Intercom API Key
    ...
    #
    config.api_key = "sQvA4Emacoeqc89aIgXveZQtjdin4_ogEi4BMWma"
    ...
    config.user.custom_data = {
      :language => Proc.new { |current_user| current_user.preferred_language },
      :user_type => Proc.new { |current_user| current_user.user_type }
    }
